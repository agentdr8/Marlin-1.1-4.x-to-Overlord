...
#define _RGB_TEST (PIN_EXISTS(RGB_LED_R) && PIN_EXISTS(RGB_LED_G) && PIN_EXISTS(RGB_LED_B))
  ...
  #endif
#elif ENABLED(PRINTER_EVENT_LEDS) && DISABLED(BLINKM) && DISABLED(PCA9632) && DISABLED(STM8S003F3_OVERLORD) && DISABLED(NEOPIXEL_LED)
  #error "PRINTER_EVENT_LEDS requires BLINKM, PCA9632, STM8S003F3_OVERLORD, RGB_LED, RGBW_LED or NEOPIXEL_LED."
#endif
